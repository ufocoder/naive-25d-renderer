...
export function projectSeg(camera: Camera, sector: Sector, linedef: Seg): SegProjection | null {
  ...
  return {
    start: {
      ...
      topY: horizontalCenter - (sector.ceilHeight! * startScale / distance),
      bottomY: horizontalCenter + (sector.floorHeight! * startScale / distance)
    },
    end: {
      screenX: endScreenX,
      topY: horizontalCenter - (sector.ceilHeight! * endScale / distance),
      bottomY: horizontalCenter + (sector.floorHeight! * endScale / distance)
    },
    sector: sector,
    distance: distance
  };
