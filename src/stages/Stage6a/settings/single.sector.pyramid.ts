...
const roomWithColumnSegs: Seg[] = [
  ...
  //
  { start: { x: 100, y: 100 }, end: { x: 300, y: 100 }, isTwoSide: true },
  { start: { x: 300, y: 100 }, end: { x: 300, y: 300 }, isTwoSide: true },
  { start: { x: 300, y: 300 }, end: { x: 100, y: 300 }, isTwoSide: true },
  { start: { x: 100, y: 300 }, end: { x: 100, y: 100 }, isTwoSide: true },
  //
